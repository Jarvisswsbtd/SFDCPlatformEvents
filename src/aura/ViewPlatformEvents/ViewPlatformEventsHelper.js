({
    connectCometd : function(component) {
        ...
        cometd.handshake(function(handshakeReply) {
            if (handshakeReply.successful) {
                ...
                var newSubscription = cometd.subscribe('/event/Text_to_Lead__e',
    ...
    onReceiveNotification : function(component, platformEvent) {
        ...
        var newNotification = {
            ...
            fName: platformEvent.data.payload.First_Name__c ,
            lName: platformEvent.data.payload.Last_Name__c,
            phone: platformEvent.data.payload.Mobile__c 
        };
        // Save notification in history
        var notifications = component.get('v.pEvents');
        notifications.push(newNotification);
        component.set('v.pEvents', notifications);
    }
})